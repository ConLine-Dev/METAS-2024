...
document.addEventListener('DOMContentLoaded', function() {
  let headerToggleBtn = document.querySelector('.sidemenu-toggle');
  if (headerToggleBtn) {
  ...
  if (
    (html.getAttribute('data-nav-style') === "menu-hover" || html.getAttribute('data-nav-style') === "icon-hover") &&
...
document.addEventListener('DOMContentLoaded', function() {
  // Verificando se .main-content existe antes de adicionar o ouvinte
  let mainContent = document.querySelector('.main-content');
  if (mainContent) {
    mainContent.addEventListener('click', function() {
      document.querySelectorAll('.slide-menu').forEach(function(ele) {
        let htmlElement = document.querySelector('html');
        if (htmlElement && (htmlElement.getAttribute('data-toggled') == 'menu-click-closed' || htmlElement.getAttribute('data-toggled') == 'icon-click-closed')) {
