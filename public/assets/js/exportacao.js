...
async function main() {
   ...
   await cards_anuais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'FCL', 'TEUS');
   // await cards_anuais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'LCL', 'TONS');
   await cards_anuais_LCL(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'LCL');
   await cards_anuais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EA', 'AÉREO', 'TONS');
   await graficos_mensais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'FCL', 'TEUS')
   // await graficos_mensais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'LCL', 'TONS')
   await graficos_mensais_LCL(teus_tons_ano_anterior, teus_tons_ano_atual, 'EM', 'LCL')
   await graficos_mensais(teus_tons_ano_anterior, teus_tons_ano_atual, 'EA', 'AÉREO', 'TONS')
