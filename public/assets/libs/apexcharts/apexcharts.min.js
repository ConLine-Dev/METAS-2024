    ...
    r(t, [
     ...
     },
     {
      ...
      value: function (t, e) {
       ...
       return (
        "string" == typeof a && a.indexOf("px") > -1 && (i = parseFloat(a)), i
       );
      },
     },
     {
    ...
    r(t, [
     ...
     },
     {
      ...
      value: function (t, e, i) {
       ...
       return (
        o || n || !l || "between" === h || (i = r.convertCatToNumeric(i)), i
       );
      },
     },
     {
      ...
      value: function (t, e, i, a, s, r, o) {
       ...
       if (n.globals.dataChanged && "circle" === p.shape)
        if (this.dynamicAnim) {
         ...
         null !=
          (C = n.globals.previousPaths[s] && n.globals.previousPaths[s][o]) &&
     ...
     },
     {
      ...
      value: function (t) {
       ...
       for (var x = 0; x < a.x.length; x++)
        if (
         ((g = a.x[x] + d.offsetX), (u = a.y[x] + d.offsetY + l), !isNaN(g))
        ) {
       ...
       if ("bubble" !== t.config.chart.type)
        for (
         ...
         var a = e[i],
          ...
          r = null;
         if (
          (s.width && s.height && (r = this.addBackgroundToDataLabel(a, s)), r)
         ) {
   ...
   return (
    r(t, [
     ...
     },
     {
      ...
      value: function () {
       var t =
         arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "asc",
        e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
        i = this.w,
        a = 0;
        ...
        if (
         ...
         "datetime" === s.xaxis.type
          ...
          : "numeric" === s.xaxis.type &&
            ((r.isXNumeric = !0),
            n.length > 0 &&
             ((this.twoDSeriesX = n), r.seriesX.push(this.twoDSeriesX))),
          r.labels.push(this.twoDSeriesX);
           ...
           (function (t) {
            for (
             ...
             0 === h &&
              ...
              (n = r +=
               s.globals.gridWidth / (s.globals.isXNumeric ? a - 1 : a));
           })({ xC: i, x1: o, y1: 0, x2: r, y2: n }));
       }
     ...
     },
     {
      ...
      value: function (t, e, i, a) {
       ...
       return void 0 === s.config.yaxis[t].title.text || t < 0
        ...
        : (a
           ? ((o =
              e.width + s.config.yaxis[t].title.offsetX + i.width / 2 + n / 2),
             0 === (r += 1) && (o -= n / 2))
           : ((o =
              -1 * e.width +
     ...
     },
     {
      ...
      value: function () {
       ...
       if (
        ...
        0 ===
         (null === (t = i.config.colors) || void 0 === t ? void 0 : t.length)
      ...
      value: function (t) {
       ...
       var e = t.theme.mode || "light",
        ...
        a = t.chart.foreColor
         ...
         : "#373d3f";
       return (
        (t.tooltip.theme = e), (t.chart.foreColor = a), (t.theme.palette = i), t
       );
      },
     },
     {
      ...
      value: function (t) {
       ...
       if (
        ...
        l <= 3 && (l = e.globals.dataPoints),
         ...
         n > t / 2 && (n /= 2),
         (s =
          ((n / r) * parseInt(e.config.plotOptions.bar.columnWidth, 10)) /
          100) < 1 && (s = 1),
         (s = s / (r > 1 ? 1 : 1.5) + 5),
     ...
     },
     {
      ...
      value: function (t) {
       this.ctx.getSyncedCharts().forEach(function (e) {
        ...
        var i =
          "selection" === t ? e.ctx.toolbar.elSelection : e.ctx.toolbar.elZoom,
      ...
      value: function (t) {
       ...
       if (null !== l)
        for (var h = 0; h < a.globals.series.length; h++) {
         var c = o[h];
         if (
          (a.globals.comboCharts && void 0 === c && l.splice(h, 0, null),
          c && c.length)
         ) {
          var d = o[h][t][1],
           g = void 0;
      ...
      value: function (t, e) {
       ...
       i.globals.isXNumeric
        ...
        : i.globals.isBarHorizontal ||
          ...
          isNaN(n) &&
           (n = a.xAxisTicksPositions[t] - a.dataPointsDividedWidth / 2)),
        i.globals.isBarHorizontal
      ...
      value: function (t) {
       ...
       if (
        ...
        var A = function (t) {
         ...
         S = function () {
          return (
           m - o.dataPointsDividedHeight + x / 2 - o.tooltipRect.ttHeight / 2
          );
         };
        o.tooltipLabels.drawSeriesTexts({
         ttItems: a.ttItems,
      ...
      value: function () {
       ...
       if (
        ...
        if (
         ...
         (r =
          ((a / c) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100),
         l.globals.isXNumeric)
        ) {
        ...
        this.barCtx.isHorizontal
         ? Array.isArray(a) &&
           a.forEach(function (t) {
            var e =
              void 0 !== t.attrs.strokeHeight ? t.attrs.strokeHeight : o / 2,
             a = i + e + o / 2;
            (h = n.drawLine(
             t.x,
             a - 2 * e,
         ...
         : Array.isArray(s) &&
           s.forEach(function (t) {
            var i =
              void 0 !== t.attrs.strokeWidth ? t.attrs.strokeWidth : r / 2,
             a = e + i + r / 2;
            (h = n.drawLine(
             a - 2 * i,
             t.y,
     ...
     },
     {
      ...
      value: function (t) {
       ...
       if (c.globals.isXNumeric)
        e =
         (n =
          (c.globals.seriesX[d][g] - c.globals.minX) / this.invertedXRatio -
          a) +
         a * this.visibleI;
       ...
       this.isFunnel &&
        (r -= (this.barHelpers.getXForValue(this.series[d][g], r) - r) / 2),
       ...
       if (
        ...
        for (var L = 1; L < A; L++) {
         ...
         if (
          ...
          w =
           this.series[d][g] >= 0 ? k - b + 2 * (this.isReversed ? b : 0) : k;
          break;
         }
         if (
          ...
          w =
           this.series[d][g] >= 0 ? k : k + b - 2 * (this.isReversed ? b : 0);
          break;
         }
        }
    ...
    r(s, [
     ...
     },
     {
      ...
      value: function (t) {
       ...
       n.globals.isXNumeric &&
        (i =
         (n.globals.seriesX[u][c] - n.globals.minX) / this.invertedXRatio -
         s / 2);
       ...
       for (var d = 0; d < t.length; d++) {
        ...
        if (
         (!this.initialAnim || i.globals.resized || i.globals.dataChanged
          ...
          : (0 ===
             (k = (u / this.fullAngle) * i.config.chart.animations.speed) &&
             (k = 1),
    ...
    r(i, [
     {
      ...
      value: function (t) {
       ...
       var g = (360 - d) / 360;
       if (
        ((e.globals.radialSize = n - n * g), this.radialDataLabels.value.show)
       ) {
        var u = Math.max(
      ...
      value: function (t) {
       ...
       for (
        ...
        e.globals.dataChanged &&
         ...
         (C =
          Math.round(
           (this.totalAngle * x.negToZero(e.globals.previousPaths[f])) / 100
          ) + k)),
     ...
     },
     {
      ...
      value: function (t) {
       ...
       return (
        (t.size *
         (100 - parseInt(e.config.plotOptions.radialBar.hollow.size, 10))) /
         100 /
         (t.series.length + 1) -
        this.margin
       );
        ...
        for (
         ...
         if (this.isHorizontal) {
          ...
          a.globals.isXNumeric &&
           (g =
            (a.globals.seriesX[n][A] - a.globals.minX) / this.xRatio - v / 2),
           (T = g + v * this.visibleI);
          var F = (l - v * z) / 2;
          if (a.config.series[n].data[A].x) {
    ...
    },
    {
     ...
     value: function (t) {
      var e = t.type,
       ...
       I = c.pathFromLine,
       T = c.pathFromArea,
       M = x.isNumber(k.globals.minYArr[s])
        ? k.globals.minYArr[s]
        : k.globals.minY;
      a ||
       (a =
        k.globals.dataPoints > 1
         ? k.globals.dataPoints - 1
      ...
      for (var X = n, z = 0; z < a; z++) {
       ...
       if (k.globals.isXNumeric) {
        ...
        void 0 === k.globals.seriesX[s][z + 1] &&
         (Y = k.globals.seriesX[s][a - 1]),
       ...
       E
        ? (n =
           p -
           M / S[this.yaxisIndex] +
           2 * (this.isReversed ? M / S[this.yaxisIndex] : 0))
        : ((n =
           p -
      ...
      if (
       ...
       w.globals.hasNullValues
        ? (null !== i[a][r] &&
          ...
          x.push(p),
          b.push(f))
        : ((p += k.curve(g + C, u, o - C, n, o, n)),
          (f += k.curve(g + C, u, o - C, n, o, n))),
        (g = o),
        (u = n),
        r === i[a].length - 2 &&
       ...
       if (
        ...
        var L = l.map(function (t, e) {
         ...
         P = Et(L);
        if (
         ((p += zt(P)), (f += zt(P)), (g = o), (u = n), "rangeArea" === e && y)
        ) {
     ...
     },
     {
      ...
      value: function (t, e, i, a, s, r) {
       var o = new m(this.ctx),
        n =
         o.getTextRects(t, e).width + this.w.config.stroke.width + 5 > s - i &&
         r - a > s - i
          ? r - a
          : s - i,
         ...
         l.forEach(function (r, h) {
          ...
          if (
           ...
           for (
            ...
            var p =
             c.config.series[c.globals.ancillaryCollapsedSeriesIndices[u]];
  ...
  (Ht = function (t, e) {
   ...
   (a.PathArray = function (t, e) {
    ...
    (a.BBox = a.invent({
     create: function (t) {
      if (
       (a.Box.apply(this, [].slice.call(arguments)), t instanceof a.Element)
      ) {
       var i;
       try {
     ...
     (t.prototype.checkAspectRatio = function (t, e) {
      ...
      return (
       o < a
        ...
        : o > a &&
          ((i[0] = this.parameters.box.width - r * a), e && (i[0] = -i[0])),
       i
      );
     }),
     SVG.extend(SVG.Element, {
